...
export default function ConfiguracaoRotas({
  ...
  const adicionarConfiguracao = () => {
    ...
    if (!nomeLimpo || !enderecoLimpo) return;

    // Evitar nomes duplicados
    if (configuracoes.some((c) => c.nome === nomeLimpo)) {
      alert("Já existe um ponto com esse nome.");
      return;
    }
    ...
    const novaConfiguracao: ConfiguracaoRota = {
      ...
      padrao: configuracoes.length === 0, // primeiro sempre vira padrão
    };
  ...
  const removerConfiguracao = (id: string) => {
    ...
    if (configuracao?.padrao) return; // não remover padrão
        ...
        {configuracaoPadrao && (
          <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <p className="text-sm text-blue-800">
              <span className="font-medium">{configuracaoPadrao.nome}:</span>{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div className="flex items-end">
            <button
              ...
              disabled={!nome.trim() || !endereco.trim()}
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-sm text-yellow-700">
              O ponto de partida padrão será usado automaticamente para todas as
              novas rotas. Você pode alternar entre diferentes pontos conforme
              necessário.
            </p>
          </div>
        </div>
